...
const BASE_URL: &str =
    "https://raw.githubusercontent.com/matsim-vsp/parallel_qsim_rust/refs/heads/main/rust_qsim/tests/resources/3-links-url";
...
fn load_files_from_url_have_content() {
    ...
    // Note: Only the inputfiles.ids, output.output_dir, and partitioning.num_parts are compared here.
    ...
    assert_eq!(
        config_content.input_files().ids,
        config_content_local.input_files().ids,
