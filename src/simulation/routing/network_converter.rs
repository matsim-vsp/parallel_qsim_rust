...
impl NetworkConverter {
    ...
    pub fn convert_io_network(
        ...
        RoutingKitNetwork::new(first_out, head, travel_time, link_ids, x, y)
    }
...
mod test {
    ...
    fn test_simple_network() {
        ...
        assert_eq!(network.travel_times, vec![1, 2, 1, 4, 2, 5]);
    ...
    fn test_simple_network_with_modes() {
        ...
        assert_eq!(car_network.travel_times, vec![2, 2, 5, 5]);
        ...
        assert_eq!(bike_network.travel_times, vec![5, 5, 5, 5]);
