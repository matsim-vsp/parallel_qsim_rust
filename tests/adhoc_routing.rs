...
#[test]
#[serial]
fn test_adhoc_routing_no_updates_200m_higher() {
    let output_dir = "test_output/mpi_test/adhoc_routing/no_updates/";
    run_mpi_simulation_and_convert_events(
        2,
        "assets/adhoc_routing/no_updates/network_200m_higher.xml",
        "assets/adhoc_routing/no_updates/agents_no_leg_200m_higher.xml",
        output_dir,
        "ad-hoc",
        None,
    );
